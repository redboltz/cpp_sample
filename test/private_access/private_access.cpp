...
// Tag::type型の、privateメンバのアドレスを保存するために用いる
// static なデータメンバを生成します
// privateデータに直接触れることがない通常のコードから、
// アドレスが保存されているvalueにアクセス可能とするために、
// Tag を いかなる形においても value に依存させないことがとても重要です
