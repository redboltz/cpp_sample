...
namespace {
    ...
    struct OuterSm_:msmf::state_machine_def<OuterSm_>
    {
        ...
        struct State2_:msmf::state_machine_def<State2_>
        {
            ...
            struct Entry1:msmf::state<>, msmf::explicit_entry<> {}; // ■■変更点■■
            ...
            struct transition_table:mpl::vector<
                ...
                msmf::Row < Entry1,    msmf::none, SubState2, msmf::none, msmf::none >, // ■■変更点■■
        ...
        struct transition_table:mpl::vector<
            //          Start   Event       Next               Action      Guard
            msmf::Row < State1, OuterEvent, State2::direct                               // ■■変更点■■
